...
| `architecture/claude-p-invocation.md` | Change how the claude-cli adapter shells out, edit hook settings, touch `--permission-mode` / `bash-guard.sh`, or debug a `claude -p` flag |
